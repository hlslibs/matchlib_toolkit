...
class ac_shared_bank_array_base
{
  ...
  ac_shared_bank_array_base<B, W  > a0;
...
class ac_shared_bank_array_base<E [D], C>
{
  typedef ac_array_1D<E,D> AC;
  typedef E B[D];
  static const size_t W = ac_max_pow2<C-1>::P;
...
class ac_shared_bank_array_3D : 
 public ac_shared_bank_array_base<ac_shared_bank_array_base<T [ThirdDim], SecondDim>, FirstDim> {};
