...
options set /Input/CompilerFlags {-DCONNECTIONS_NAMING_ORIGINAL -DCONNECTIONS_ACCURATE_SIM -DSEGMENT_BURST_SIZE=16}
...
# Turn off UVM flow explicitly
catch {flow package forget /UVM}
