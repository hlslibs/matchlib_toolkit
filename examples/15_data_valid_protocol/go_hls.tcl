...
options set Input/CompilerFlags {-DCONNECTIONS_NAMING_ORIGINAL -DHLS_CATAPULT -DSC_INCLUDE_DYNAMIC_PROCESSES -DCONNECTIONS_ACCURATE_SIM -DSEGMENT_BURST_SIZE=16}
